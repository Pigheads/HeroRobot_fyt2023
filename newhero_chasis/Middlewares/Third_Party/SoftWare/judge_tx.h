...
#define HIGHT_6M  0x00
#define HIGHT_10M 0x01
...
{
    ext_client_graphic_basic_t ext_client_graphic_basic;
    ext_client_graphic_draw_t ext_client_graphic_draw[2];
} ext_client_graphic_drawtwo_t;
...
void JudgeUI_ShootBlock(uint8_t robot_id,uint8_t blockstate);
void JudgeUI_ShootHight(uint8_t robot_id,uint8_t hight);
void JudgeUI_AimState(uint8_t robot_id,uint8_t aimstate);
